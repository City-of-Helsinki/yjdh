...
class HandlerApplicationViewSet(BaseApplicationViewSet):
    ...
    @action(methods=["GET"], detail=False)
    @transaction.atomic
    def export_new_accepted_applications_pdf(self, request) -> StreamingHttpResponse:
    ...
    @action(methods=["GET"], detail=False)
    @transaction.atomic
    def export_new_rejected_applications_pdf(self, request) -> StreamingHttpResponse:
        return self._pdf_response(
            self._create_application_batch(ApplicationStatus.REJECTED)
        )
    ...
    def _pdf_response(self, queryset) -> StreamingHttpResponse:
