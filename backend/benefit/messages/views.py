...
from messages.permissions import IsMessageAuthor
...
class ApplicantMessageViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [BFIsAuthenticated, TermsOfServiceAccepted, IsMessageAuthor]
...
class HandlerMessageViewSet(ApplicantMessageViewSet):
    serializer_class = MessageSerializer
    permission_classes = [BFIsHandler, IsMessageAuthor]
