...
env = environ.Env(
    ...
    CSRF_TRUSTED_ORIGINS=(list, ["localhost:3000", "localhost:3100", "localhost:8000"]),
    ...
    DEMINIMIS_AUTH_CREDENTIAL=(str, "username:password"),
    ...
    AHJO_RETRY_FAILED_OLDER_THAN=(int, 1),
    AHJO_MAX_RETRIES_PER_RUN=(int, 5),
...
DEMINIMIS_AUTH_CREDENTIAL = env("DEMINIMIS_AUTH_CREDENTIAL")
...
AHJO_RETRY_FAILED_OLDER_THAN = env.int("AHJO_RETRY_FAILED_OLDER_THAN")
AHJO_MAX_RETRIES_PER_RUN = env.int("AHJO_MAX_RETRIES_PER_RUN")
