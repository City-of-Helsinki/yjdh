...
try:
    ...
    RESILIENT_LOGGER_AVAILABLE = True
except ImportError:
    RESILIENT_LOGGER_AVAILABLE = False
...
def log(
    ...
    # Use resilient logger if available and configured
    if RESILIENT_LOGGER_AVAILABLE and getattr(settings, "RESILIENT_LOGGER", None):
