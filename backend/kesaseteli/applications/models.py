...
class EmployerSummerVoucherQuerySet(models.QuerySet):
    ...
    def for_export(self):
        """Load all relations, filter out unsubmitted applications, and add a stable
        row number annotation.

        This is the base queryset for all Excel and JSON exports.
        It excludes any applications missing a ``submitted_at`` date to ensure
        the row_number window annotation and ordering remain consistent. It also
        applies the required select_related, prefetch_related, and ordering.

        Returns:
            QuerySet with unsubmitted applications filtered out and all export-related
        ...
        return (
            ...
            .filter(application__submitted_at__isnull=False)
