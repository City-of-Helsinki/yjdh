...
- Node >=24.18.1 (match with dockerfile: registry.access.redhat.com/ubi9/nodejs-24)
- pnpm 11.18.0
- Git
- Docker
...
Adding an entry such as `browserslist: '>=4.16.5'`
to the `overrides` section of [pnpm-workspace.yaml](./pnpm-workspace.yaml)
Run `pnpm install`
