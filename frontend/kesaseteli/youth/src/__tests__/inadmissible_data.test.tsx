...
import InadmissibleDataPage from 'kesaseteli/youth/app/[locale]/inadmissible_data/page';
import renderComponent from 'kesaseteli-shared/__tests__/utils/components/render-component';
import React from 'react';
import { waitFor } from 'shared/__tests__/utils/test-utils';
import { DEFAULT_LANGUAGE } from 'shared/i18n/i18n';

describe('frontend/kesaseteli/youth/src/app/[locale]/inadmissible_data/page.tsx', () => {
  it('should not violate accessibility', async () => {
    const {
      renderResult: { container },
    } = renderComponent(await InadmissibleDataPage({ params: Promise.resolve({ locale: DEFAULT_LANGUAGE }) }));
  ...
  it('redirects to main page when clicking the button', async () => {
    ...
    renderPage(await InadmissibleDataPage({ params: Promise.resolve({ locale: DEFAULT_LANGUAGE }) }), { push: spyPush });
