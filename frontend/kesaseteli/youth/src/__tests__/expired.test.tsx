...
import ExpiredPage from 'kesaseteli/youth/app/[locale]/expired/page';
...
describe('frontend/kesaseteli/youth/src/pages/expired.tsx', () => {
  const params = Promise.resolve({ locale: DEFAULT_LANGUAGE });

  it('should not violate accessibility', async () => {
    const Page = await ExpiredPage({ params });
    const {
