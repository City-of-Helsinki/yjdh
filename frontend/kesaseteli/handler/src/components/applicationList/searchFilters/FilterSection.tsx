...
const $FiltersSection = styled.section`
  background-color: ${(props: { theme: DefaultTheme }) => props.theme.colors.busLight};
  padding: ${(props: { theme: DefaultTheme }) => props.theme.spacing.m};
  margin-bottom: ${(props: { theme: DefaultTheme }) => props.theme.spacing.m};
  border: 1px solid ${(props: { theme: DefaultTheme }) => props.theme.colors.black10};
  display: flex;
...
const $FilterTitle = styled.h2`
  font-size: ${(props: { theme: DefaultTheme }) => props.theme.fontSize.heading.xxs};
  font-weight: 600;
  margin-top: 0;
