...
export interface Step1 {
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.PURCHASED_SERVICE]?: boolean | null;
...
export interface Step2 {
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_FINANCIAL_SUPPORT_FOR_EMPLOYMENT]?:
    | boolean
    | null;
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_SUBSIDISED_EMPLOYED]?:
    | boolean
    | null;
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_SUBSIDISED_NUMBER]?:
    | string
    | null;
