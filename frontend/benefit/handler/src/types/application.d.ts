...
export interface ApplicationForm {
  ...
  [APPLICATION_FIELD_KEYS.COMPANY_NUMBER_OF_EMPLOYEES]?: number | '' | null;
  [APPLICATION_FIELD_KEYS.COMPANY_BUSINESS_BRIEF]?: string;
  [APPLICATION_FIELD_KEYS.PURCHASED_SERVICE]?: boolean | null;
  ...
  [APPLICATION_FIELD_KEYS.OTHER_FINANCIAL_SUPPORT_FOR_EMPLOYMENT]?:
    | boolean
    | null;
  [APPLICATION_FIELD_KEYS.OTHER_SUBSIDISED_EMPLOYED]?: boolean | null;
  [APPLICATION_FIELD_KEYS.OTHER_SUBSIDISED_NUMBER]?: string | null;
  [APPLICATION_FIELD_KEYS.ROLE_OF_EMPLOYEE_IN_ORGANIZATION]?: string;
