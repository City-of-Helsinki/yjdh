...
const SetInstalmentToPendingButton: React.FC<Props> = ({ application }) => {
  ...
  if (
    ...
    application.secondInstalment.status === INSTALMENT_STATUSES.PENDING
  ) {
    return null;
  }
  ...
  return (
    ...
    >
      {mutation.isLoading
        ...
        : t('common:applications.paidSalaries.buttons.pending')}
    </Button>
  );
};

export default SetInstalmentToPendingButton;
