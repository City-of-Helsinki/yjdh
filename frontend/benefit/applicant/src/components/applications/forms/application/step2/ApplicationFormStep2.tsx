...
const ApplicationFormStep2: React.FC<DynamicFormStepComponentProps> = ({
  ...
  const isAbleToSelectSalaryBenefit =
    formik.values.paySubsidyGranted === PAY_SUBSIDY_TYPES.DEFAULT;
        ...
        <$GridCell $colSpan={12}>
          ...
          >
            <$RadioButton
              ...
              value={PAY_SUBSIDY_TYPES.DEFAULT}
              label={t(
            ...
            <$RadioButton
              ...
              onChange={() => {
                formik.setFieldValue(
                  fields.paySubsidyGranted.name,
                  PAY_SUBSIDY_TYPES.AGED
                );
              }}
              checked={
                formik.values.paySubsidyGranted === PAY_SUBSIDY_TYPES.AGED
              }
            />
            <$RadioButton
              ...
              checked={
                formik.values.paySubsidyGranted === PAY_SUBSIDY_TYPES.NONE
              }
            />
          </SelectionGroup>
        </$GridCell>
