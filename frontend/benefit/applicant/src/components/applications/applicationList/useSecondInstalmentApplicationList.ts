...
import { APPLICATION_STATUSES, INSTALMENT_STATUSES} from 'benefit-shared/constants';
import {
...
): keyof DefaultTheme['colors'] => 'summerMediumLight';
...
const useSecondInstalmentApplicationList = ({
                              status,
                              isArchived,
                              orderByOptions,
...
export default useSecondInstalmentApplicationList;
