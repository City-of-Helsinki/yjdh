...
export type FormFieldsStep1 = {
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.ORGANIZATION_TYPE]: string;
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.APPLCANT_LANGUAGE]: SUPPORTED_LANGUAGES;
  [APPLICATION_FIELDS_STEP1_KEYS.DE_MINIMIS_AID]: boolean;
  [APPLICATION_FIELDS_STEP1_KEYS.CO_OPERATION_NEGOTIATIONS]: boolean;
  [APPLICATION_FIELDS_STEP1_KEYS.CO_OPERATION_NEGOTIATIONS_DESCRIPTION]: string;
};

export type FormFieldsStep2 = typeof APPLICATION_FIELDS_STEP2;
