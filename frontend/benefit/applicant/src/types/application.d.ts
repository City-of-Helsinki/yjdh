...
export type Employee = {
  ...
  [EMPLOYEE_KEYS.MONTHLY_PAY]?: number | null;
  [EMPLOYEE_KEYS.VACATION_MONEY]?: number | null;
  [EMPLOYEE_KEYS.OTHER_EXPENSES]?: number | null;
  [EMPLOYEE_KEYS.WORKING_HOURS]?: number | null;
  [EMPLOYEE_KEYS.COLLECTIVE_BARGAINING_AGREEMENT]?: string;
  [EMPLOYEE_KEYS.IS_LIVING_IN_HELSINKI]?: boolean;
  [EMPLOYEE_KEYS.EMPLOYEE_COMMISSION_AMOUNT]?: number | null;
...
export interface Step1 {
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.APPLICANT_LANGUAGE]?: SUPPORTED_LANGUAGES | null;
...
export interface Step2 {
  ...
  [APPLICATION_FIELDS_STEP2_KEYS.BENEFIT_TYPE]?: BENEFIT_TYPES | null;
