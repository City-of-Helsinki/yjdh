...
export const APPLICATION_START_DATE_WITHIN_MONTHS =
  APPLICANT_APPLICATION_START_DATE_WITHIN_MONTHS;
...
export const APPLICATION_INITIAL_VALUES = {
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.COMPANY_NUMBER_OF_EMPLOYEES]: null,
  [APPLICATION_FIELDS_STEP1_KEYS.COMPANY_BUSINESS_BRIEF]: '',
  [APPLICATION_FIELDS_STEP1_KEYS.PURCHASED_SERVICE]: null,
  ...
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_FINANCIAL_SUPPORT_FOR_EMPLOYMENT]: null,
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_SUBSIDISED_EMPLOYED]: null,
  [APPLICATION_FIELDS_STEP2_KEYS.OTHER_SUBSIDISED_NUMBER]: null,
...
export const MAX_VERY_LONG_STRING_LENGTH = 6000 as const;
