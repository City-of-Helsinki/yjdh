...
export const APPLICATION_INITIAL_VALUES = {
  ...
  employee: {
    ...
    [APPLICATION_FIELDS_STEP2.employee.WORKING_HOURS]: '',
    [APPLICATION_FIELDS_STEP2.employee.COLLECTIVE_BARGAINING_AGREEMENT]: '',
    [APPLICATION_FIELDS_STEP2.employee.MONTHLY_PAY]: '',
    [APPLICATION_FIELDS_STEP2.employee.OTHER_EXPENSES]: '',
    [APPLICATION_FIELDS_STEP2.employee.VACATION_MONEY]: '',
  ...
  [APPLICATION_FIELDS_STEP1_KEYS.ORGANIZATION_TYPE]: '',
  ...
  [APPLICATION_FIELDS_STEP2_KEYS.START_DATE]: null,
  [APPLICATION_FIELDS_STEP2_KEYS.END_DATE]: null,
