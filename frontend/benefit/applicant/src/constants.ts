...
export const APPLICATION_INITIAL_VALUES = {
  ...
  employee: {
    ...
    [APPLICATION_FIELDS_STEP2.employee.WORKING_HOURS]: null,
    [APPLICATION_FIELDS_STEP2.employee.COLLECTIVE_BARGAINING_AGREEMENT]: '',
    [APPLICATION_FIELDS_STEP2.employee.MONTHLY_PAY]: null,
    [APPLICATION_FIELDS_STEP2.employee.OTHER_EXPENSES]: null,
    [APPLICATION_FIELDS_STEP2.employee.VACATION_MONEY]: null,
    [APPLICATION_FIELDS_STEP2.employee.COMMISSION_DESCRIPTION]: '',
    [APPLICATION_FIELDS_STEP2.employee.EMPLOYEE_COMMISSION_AMOUNT]: null,
  },
  bases: [],
  ...
  archived: false,
  [APPLICATION_FIELDS_STEP2_KEYS.BENEFIT_TYPE]: null,
